...
;object:Lab0x03-HexCalc.asm
;	nasm -f elf32 -g -F dwarf Lab0x03-HexCalc.asm
;
;go: Lab0x03-HexCalc.o
;	ld -m elf_i386 Lab0x03-HexCalc.o -o go
...
section .data
	...
	msg1 db NEWLINE, 'Welcome to the Hexadecimal Age!', NEWLINE, 0
	msg1len equ $-msg1

	msg2 db 'We do math in hexadecimal...', NEWLINE, 0
	msg2len equ $-msg2
